...
//        $scope.emoteInfo2.emoteName = 'ierage';
    ...
    $scope.swapEmotes = function () {
      console.log('starting emote swap');
      // TODO: in ES6, use array + destructuring for swap
      var tempEmoteInfo = $scope.emoteInfo1;
      $scope.emoteInfo1 = $scope.emoteInfo2;
      $scope.emoteInfo2 = tempEmoteInfo;
